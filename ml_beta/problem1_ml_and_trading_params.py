...
class MyTradingParams(TradingSystemParameters):
    ...
    def getExecutionSystem(self):
        return Problem1ExecutionSystem(enter_threshold=0.99,
                                    exit_threshold=0.55,
                                    longLimit=10000,
                                    shortLimit=10000,
...
class MyModelLearningParams(ModelLearningSystemParamters):
    ...
    def getFeatureSelectionConfigDicts(self):
        tf = self.tsParams.getTradingFunctions()
        return tf.getFeatureSelectionConfigDicts()

    def getFeatureTransformationConfigDicts(self):
        tf = self.tsParams.getTradingFunctions()
        return tf.getFeatureTransformationConfigDicts()

    def getModelConfigDicts(self):
        tf = self.tsParams.getTradingFunctions()
        return tf.getModelConfigDicts()
